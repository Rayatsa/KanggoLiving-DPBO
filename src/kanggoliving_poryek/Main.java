...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Technician technician = new Technician(201, "Instalasi & Listrik", 301, "Raihan Yassar", "raihan@tech.com",
                "raihan123", "089999", "Technician");
        ...
        System.out
                .println("Teknisi    : " + technician.getName() + " (Spesialisasi: " + technician.checkSystem(1) + ")"); // test
                                                                                                                         // method
                                                                                                                         // checkSystem
        System.out.println();
        ...
        TicketProblem tiketMasalah = client
                .submitProblem("Instalasi listrik kamar utama sering korsleting dan perlu desain ulang.");
        ...
        DesignProject proyekDesain = new DesignProject(701, konsultasi.getConsultationId(), "Modern Japandi",
                25000000.0);

        // Validasi budget dari Klien
        double budgetKlien = 30000000.0;
        System.out.println("Estimasi Budget Desain : Rp"
                + String.format(new java.util.Locale("in", "ID"), "%,.0f", proyekDesain.getEstimatedBudget()));
        System.out.println("Budget yang dimiliki Klien : Rp"
                + String.format(new java.util.Locale("in", "ID"), "%,.0f", budgetKlien));
