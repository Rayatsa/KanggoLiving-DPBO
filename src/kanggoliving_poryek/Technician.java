...
public class Technician extends User{
    ...
    public Technician(int technicianId, String specialization, int userId, String name, String email, String password, String phone, String role) {
    ...
    public boolean finalInsception(int ticketId){
    ...
    //MASIH ERROR MENUNGGU CLASS REPORT SELESAI (ALAN KERJAIN CEPET)
