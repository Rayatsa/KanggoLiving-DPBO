...
Dokumen ini berisi pemodelan **Entity Relationship Diagram (ERD)** serta **Kamus Data** untuk sistem ERP skala mikro **KanggoLiving** berdasarkan implementasi OOP dan skema database sistem.

---

## 1. Diagram ERD (Mermaid.js)

Berikut adalah representasi visual ERD menggunakan format **Mermaid.js**. Diagram ini menggambarkan entitas, atribut (termasuk Primary Key/Foreign Key), beserta hubungannya.
